...
ControlSystemPID initControlSystemPID(void){
    ...
    double kd_alt = -0.0;
    double alt_outMin = -25.0 * deg2rad;
    double alt_outMax = 25.0 * deg2rad;
    ...
    // airspeed2throttle
    double kp_airspeed = 0.0;
    double ki_airspeed = 0.0;
    double kd_airspeed = 0.0;
    double airspeed_outMin = 0.0;
    double airspeed_outMax = 0.0;
