 ...
 * under the assumption of diagonal inertia tensor (no cross-products of inertia).
 ...
 * @param[in]  ac    Pointer to aircraft struct containing mass and inertial properties of the
 *                   aircraft.
 ...
 */
void computeStateDerivative(const StateVector* X, AircraftParams* acParams, 
    Vector3* F, Vector3* M, double* Xdot){
