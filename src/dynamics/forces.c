 ...
 * @param[in]  U         Pointer to the control vector.
 ...
 */
void computeForcesAndMoments(StateVector* X, ControlVector* U, AircraftParams* acParams,
    ...
    computeAerodynamicForces(X, U, acParams, &F_aero, &M_aero);

    computePropulsionForces(X, U, acParams, &F_prop, &M_prop);
